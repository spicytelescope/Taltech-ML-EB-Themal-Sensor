...
#define AI_NETWORK_MODEL_SIGNATURE     "e6d65e2ed137d2ccdb8b8631e09b2c7f"
...
#define AI_TOOLS_DATE_TIME   "Mon Dec 13 01:26:20 2021"
...
AI_STATIC ai_array serving_default_flatten_input0_output_array;   /* Array #6 */
...
AI_STATIC ai_tensor serving_default_flatten_input0_output;   /* Tensor #6 */
AI_STATIC ai_tensor serving_default_flatten_input0_output0;   /* Tensor #7 */
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 80, 1, 1, 1), AI_STRIDE_INIT(4, 4, 320, 320, 320),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 80, 80, 1, 1), AI_STRIDE_INIT(4, 4, 320, 25600, 25600),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1024, 80, 1, 1), AI_STRIDE_INIT(4, 4, 4096, 327680, 327680),
